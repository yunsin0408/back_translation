...
* **Threshold Interval Unit:**  Valid units of measurement for threshold intervals include:
    * Months
    * Weeks
    * Years
    * Days
...
* **Attribute Source Type Code:**  Valid source types include:
    * fec
    * sample

* **Attribute Source Criticality:** Valid criticality levels include:
    * Evident, Safety
    * Evident, operational
    * Evident, Economic
    * Hidden, Safety
...
* **Task Code:** Valid task codes include:
...
* **Limit Type:** Valid limit types include:
...
* **Origin of Equipment/Harness/Wire:** Valid origins include:
    * Manufacturer
    * Vendor
    * Partner
...
* **EPWG Review & Approval:**  Bike data modules *must* be reviewed and approved by the EPWG (Engineering Product Working Group) before publication.

### 3. Content & Data Requirements

* **Concept Sophistication Examples:** The Bike data set *must* contain examples demonstrating the application of constructs and principles representing various levels of conceptual sophistication.
