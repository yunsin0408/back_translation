...
* **Warning (Applicable to app-0001):** AECMA Heavy duty Oil 1988 (internalRef: sup-0002) is a dangerous substance.  Do not get it on your skin. Use in a well-ventilated area. If swallowed, seek immediate medical attention. If it gets in your eyes, wash with clean water and seek medical advice.
*  Avoid getting lubricant into the brake system. Oil contamination can reduce braking efficiency.

### Required Materials & Tools

* **Lubricants:**
    * ACME sticky lube 52B (shortName: Wet lube, internalRef: sup-0001) - For wet conditions.
    * AECMA Heavy duty Oil 1988 (shortName: Dry lube, internalRef: sup-0002) - For dry conditions (Applicable to app-0001).
* **Supplies:**
...
1. Apply lubricant to the following components (refer to figures for location):
...
2. Position the floor covering (seq-0002) beneath the chain to catch drips.
3. **Conditional Lubrication:**
    * **App-0001 (Wet Conditions):** Apply wet lube (sup-0002) to each chain roller (fig-0004) sparingly.
    * **App-0002 (Dry Conditions):** Apply dry lube (sup-0001) to each chain roller (fig-0004) sparingly.
4. Slowly turn the cranks rearward while applying lubricant.
5. **Caution:** Avoid getting lubricant onto the brake system.
6. Allow the lubricant to soak into the chain.

### Step 3: Check Lubricated Parts

1. Inspect the rear wheel rim and clean any excess lubricant.
2. Verify that all chain links move freely. Relubricate stubborn links as needed (refer back to Step 2).
3. Inspect all lubricated parts and wipe away excess lubricant with a clean cloth (seq-0001).
