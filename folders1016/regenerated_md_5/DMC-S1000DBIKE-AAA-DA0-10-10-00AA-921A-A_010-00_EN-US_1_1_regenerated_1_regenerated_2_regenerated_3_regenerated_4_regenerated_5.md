# DMC-S1000DBIKE-AAA-DA0-10-10-00AA-921A-A_010-00_EN-US_1_1_regenerated_1_regenerated_2_regenerated_3_regenerated_4_regenerated
...
*   **step**:
    *   **stepNumber**: 1
    *   **stepText**: Remove the wheel from the bicycle.
*   **step**:
    *   **stepNumber**: 2
    *   **stepText**: Deflate the tire completely.
*   **step**:
    *   **stepNumber**: 3
    *   **stepText**: Remove the tire from the rim.
*   **step**:
    *   **stepNumber**: 4
    *   **stepText**: Inspect the tire for any damage.
*   **step**:
    *   **stepNumber**: 5
    *   **stepText**: Install the new tire onto the rim.
*   **step**:
    *   **stepNumber**: 6
    *   **stepText**: Inflate the tire to the recommended pressure.
*   **step**:
    *   **stepNumber**: 7
    *   **stepText**: Reinstall the wheel onto the bicycle.